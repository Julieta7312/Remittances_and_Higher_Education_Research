...
''' PLOTS '''
# Check the existense of a linear relationship between the dependent and independent variables with the scatterplot.
...
# Check the correlation between the variables with the heatmap.
